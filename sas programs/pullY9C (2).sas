...
libname ccar2011 "&fpath";

%let sdate = 1997q1;
%let edate = 2013q1;
*retrieve MAY9 data;
%let mvars = bc01000 bck0450 bck0470 ac00600
...
%let rmvars = assets assets_avg assets_ie_avg assets_tr 
...
run;
  ...
  *output;
  data ccar2011.may9c_matchange; set may9c_vars; run;
